...
enable_auto_observer_depth = 5  # the depth of the function call that we want to observe
observe_up_to_depth = True  # observe up to the depth of the function call, if False, only observe the function call at the depth
neglect_hidden_func = (
